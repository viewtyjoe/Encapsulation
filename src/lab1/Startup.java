...
//        employee.ssn = "333-1234;
        ...
        manager.addEmployee("Peter", "Piper", "333-1234");
        manager.doOrientation("333-1234", "132");

        System.out.println("The employee's status is: " + manager.getEmployeeStatus("333-1234"));
    }
